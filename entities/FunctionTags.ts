export enum FunctionTags {
  ...
  "Décoration: Médaille de la securité intérieure" = "medaille_securite_interieure",
  "Décoration: Médaille militaire" = "medaille_militaire",
  "Décoration: Ordre de la nation" = "ordre_nation",
  "Décoration: Ordre du mérite" = "ordre_merite",
  //"Décoration : Médaille agrafe" = "medaille_agrafe",
  ...
  "Préfet" = "prefet",
  //"Préfet département" = "prefet_departement",
  //"Préfet département code" = "prefet_departement_code",
  //"Préfet région" = "prefet_region",
  "Président" = "president",
  ...
  //"Sous-préfecture département code" = "sous-prefecture_departement_code",
  "Tribunal" = "tribunal",
