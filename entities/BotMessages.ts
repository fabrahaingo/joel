export enum HelpMessages {
  DEFAULT = `JOEL est un robot Telegram sans but lucratif qui permet de suivre les nominations de vos contacts au [Journal Officiel](https://www.journal-officiel.gouv.fr/pages/accueil/) 👀
Il a vu le jour en 2022 👶.
Le robot s'appuie principalement sur l'outil [JORFSearch](https://www.steinertriples.ch/ncohen/data/nominations_JORF/) créé par [Nathann](https://www.steinertriples.ch/ncohen/).
